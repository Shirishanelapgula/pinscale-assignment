...
const CreditAndDebit = (props) => {
  ...
  const dUrl =
    "https://res.cloudinary.com/dqfmzzr5g/image/upload/v1690822751/Group_73_1_qhryhp.png";
  const cUrl =
    "https://res.cloudinary.com/dqfmzzr5g/image/upload/v1690818802/Group_73_laemtg.png";

  const url = type === "debit" ? dUrl : cUrl;
    ...
    <div className="transaction-container">
      ...
      <div className="icons-container">
        <button type="button" className="icon-buttons">
          <img
            src={
              "https://res.cloudinary.com/dqfmzzr5g/image/upload/v1690795340/pencil-02_wn3oly.png"
            }
            alt="edit"
            className="mini"
          />
